...
import { Save, User, Lock, Bell, Globe, CreditCard, Eye, EyeOff, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-gray-500 animate-pulse">Chargement de vos paramètres...</p>
          </div>
        </div>
      </DashboardLayout>
    );
        ...
        <Tabs defaultValue="profile" className="space-y-8">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-400 mt-1">Modifiez vos informations de profil</p>
                </div>
                <Button 
                  onClick={handleSave} 
          ...
          <TabsContent value="security">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-semibold text-white">Sécurité du compte</h2>
                  <p className="text-gray-400 mt-1">Gérez votre mot de passe et la sécurité de votre compte</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-400 mt-1">Gérez vos préférences de notification</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:bg-gray-800 transition-all group cursor-pointer">
                  <div className="space-y-1">
                    <h3 className="font-medium text-white group-hover:text-primary transition-colors">Nouvelles réservations</h3>
                    <p className="text-sm text-gray-400">Recevoir des notifications pour les nouvelles réservations</p>
                  </div>
                  <div className="relative">
                    <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:bg-gray-800 transition-all group cursor-pointer">
                  <div className="space-y-1">
                    <h3 className="font-medium text-white group-hover:text-primary transition-colors">Paiements</h3>
                    <p className="text-sm text-gray-400">Recevoir des notifications pour les paiements</p>
                  </div>
                  <div className="relative">
                    <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:bg-gray-800 transition-all group cursor-pointer">
                  <div className="space-y-1">
                    <h3 className="font-medium text-white group-hover:text-primary transition-colors">Messages</h3>
                    <p className="text-sm text-gray-400">Recevoir des notifications pour les nouveaux messages</p>
                  </div>
                  <div className="relative">
                    <Switch
                ...
                <div className="flex items-center justify-between p-4 bg-gray-800/50 rounded-xl border border-gray-700 hover:bg-gray-800 transition-all group cursor-pointer">
                  <div className="space-y-1">
                    <h3 className="font-medium text-white group-hover:text-primary transition-colors">Mises à jour système</h3>
                    <p className="text-sm text-gray-400">Recevoir des notifications pour les mises à jour système</p>
                  </div>
                  <div className="relative">
                    <Switch
          ...
          <TabsContent value="billing">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-2xl font-semibold text-white">Facturation</h2>
                  <p className="text-gray-400 mt-1">Gérez vos informations de paiement</p>
                </div>
              </div>
